        ...
        return (
            <ViewShot ref="viewShot" style={{flex: 1}}>
                ...
                <View style={{
                    ...
                    <CircleButton size={45} primaryColor='#4cb0e4' secondaryColor='#66c87d'
                                  onPressButtonTop={this.botaoCima} onPressButtonBottom={this.botaoBaixo}
                                  onPressButtonRight={this.botaoDir} onPressButtonLeft={this.botaoEsq}/>
                </View>
            </ViewShot>
